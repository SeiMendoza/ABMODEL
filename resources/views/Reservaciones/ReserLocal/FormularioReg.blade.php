                ...
                <div class="container ">
                        ...
                        <div class="form-group col-md-6 ">
                            ...
                            <select name="PrecioEntrada" id="PrecioEntrada" class="form-control">
                                ...
                                @else
                                    <option disabled="disabled" selected="selected" value="">-- Seleccione Uno --</option>
                                @endif
                                <option value="L.100 con Alimentos">L.100 con Alimentos</option>
                                <option value="L.80 sin Alimentos">L.  80 sin Alimentos</option>
                            </select>
                            @error('PrecioEntrada')
                               <span class="menerr" class="menerr" style="color:red">{{ $message }}</span>
                             @enderror
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 ">
                            ...
                            <input name="Anticipo" type="number"  class="form-control" id="Anticipo"
                                placeholder="Ingrese el adelanto a cancelar" value="{{ old('Anticipo')}}" required>
                            @error('Anticipo')
                                <span class="menerr" class="menerr" style="color:red">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 ">
                            ...
                            <input name="Pendiente" type="number"  class="form-control" id="Pendiente"
                                placeholder="Ingrese la cantidad pendiente a cancelar" value="{{ old('Pendiente')}}" required>
                            @error('Pendiente')
                                <span class="menerr" class="menerr" style="color:red">{{ $message }}</span>
                            @enderror
                        </div>
