        ...
        <div class="wrapper wrapper--w960">
            <div class="card border-radius-sm border-0" style="padding-bottom:0">
                <div class="card-body border-radius-sm border-0" style="padding-bottom:0">
                    <form method="POST" action="{{ route('kiosko_res.update', ['id' => $registro->id]) }}"
                            ...
                            <div class="col-6">
                                <div class="font-robo form-group">
                                    ...
                                    <input class="form-control border-radius-sm" type="text"
                                        ...
                                        maxlength="30" value="{{ old('name', $registro->nombreCliente) }}" required>
                                    @error('name')
                            ...
                            <div class="col-4">
                                <div class="font-robo form-group">
                                    ...
                                    <input name="inicio" type="time" class="form-control border-radius-sm"
                                        id="inicio" min="06:00:00" max="23:00:00"
                                        placeholder="Ingrese la hora de llegada"
                                        value="{{ old('inicio', $registro->horaI) }}" required>
                                    @error('inicio')
                                        <strong class="menerr" style="color:red">{{ $message }}</strong>
                                    @enderror
                                </div>
                            ...
                            <div class="col-4">
                                <div class="font-robo form-group">
                                    ...
                                    <input name="fin" type="time" class="form-control border-radius-sm"
                                        id="fin" min="07:00:00" max="00:00:00"
                                        placeholder="Ingrese la hora de llegada"
                                        value="{{ old('fin', $registro->horaF) }}" required>
                                    @error('fin')
                                        <strong class="menerr" style="color:red">{{ $message }}</strong>
                                    @enderror
                                </div>
                                    ...
                                    <select name="kiosko" onchange="quitarerror()" id="kiosko"
                                        ...
                                        @else
                                            <option disabled="disabled" selected="selected"
                                                value="{{ $registro->kiosko_id }}">Seleccione un kiosko</option>
                                            @foreach ($kiosko as $c)
                                                <option
                                                    value="{{ $c->id }}"{{ $registro->kiosko_id === $c->id ? 'selected' : '' }}>
                                                    {{ $c->codigo }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="col-4">
                                <div class="font-robo form-group">
                                    ...
                                    <input name="cantidadN" type="number" class="form-control border-radius-sm"
                                        ...
                                        placeholder="Cantidad de niños a asistir"
                                        value="{{ old('cantidadN', $registro->cantidadNinios) }}">
                                    @error('cantidadN')
                                        <span class="menerr" class="menerr" style="color:red">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-4">
                                <div class="font-robo form-group">
                                    ...
                                    <input class="form-control border-radius-sm" type="number"
                                        ...
                                        oninput="calcular()" value="{{ old('precioN', $registro->precioNinios) }}"
                                        required>
                                    @error('precioN')
                                        <strong class="menerr" style="color:red">{{ $message }}</strong>
                                    @enderror
                                ...
                                <div class="font-robo form-group">
                                    ...
                                    <input name="cantidad" type="number" class="form-control border-radius-sm"
                                        id="cantidad" max="20" min="2" maxlength="3" minlength="1"
                                         oninput="calcular()" required
                                        placeholder="Cantidad de personas a asistir"
                                        value="{{ old('cantidad', $registro->cantidadAdultos) }}">
                                    @error('cantidad')
                                        <span class="menerr" class="menerr" style="color:red">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-4">
                                <div class="font-robo form-group">
                                    ...
                                    <input class="form-control border-radius-sm" type="number"
                                        ...
                                        oninput="calcular()" value="{{ old('precio', $registro->precioAdultos) }}"
                                        required>
                                    @error('precio')
                                        <strong class="menerr" style="color:red">{{ $message }}</strong>
                                    @enderror
                            ...
                            <div class="col-4">
                                <div class="font-robo form-group">
                                    ...
                                    <input name="total" type="number" class="form-control border-radius-sm"
                                        ...
                                        value="{{ old(
                                            'total',
                                            $registro->precioAdultos * $registro->cantidadAdultos + $registro->precioNinios * $registro->cantidadNinios,
                                        ) }}"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="font-robo form-group" style="margin-bottom: 5px">
                                    ...
                                    <input name="anticipo" type="number" class="form-control border-radius-sm"
                                        id="anticipo" oninput="calcular()" min="0" max="{{$registro->precioAdultos * $registro->cantidadAdultos + $registro->precioNinios * $registro->cantidadNinios}}"
                                        placeholder="Ingrese el pago adelantado"
                                        value="{{ old('anticipo', $registro->anticipo) }}" required>
                                    @error('anticipo')
                                        <strong class="menerr" style="color:red">{{ $message }}</strong>
                                    @enderror
                                </div>
                            ...
                            <div class="col-6">
                                <div class="font-robo form-group" style="margin-bottom: 5px">
                                    ...
                                    <input name="pendiente" type="number" class="form-control border-radius-sm"
                                        ...
                                        value="{{ old(
                                            'pendiente',
                                            $registro->precioAdultos * $registro->cantidadAdultos +
                                                $registro->precioNinios * $registro->cantidadNinios -
                                                $registro->anticipo,
                                        ) }}"
                                        readonly>
                                </div>
                                ...
                                <div class="font-robo form-group" style="margin-bottom: 5px">
                                    ...
                                    <select name="formaPago" required onchange="quitarerror()"
                                        ...
                                        @if (old('formaPago', $registro->formaPago))
                                            ...
                                            @else
                                                @if (old('formaPago', $registro->formaPago) == 2)
                                        ...
                                        @else
                                            <option disabled="disabled" selected="selected"
                                                value="{{ old('formaPago', $registro->formaPago) }}">Seleccione una forma
                                                de pago</option>
                                        @endif
