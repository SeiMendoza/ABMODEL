                    ...
                    <div class="row row-space">
                        <div class="col-3">
                            <div class="font-robo form-group">
                                ...
                                <br><br>
                                <label id="label" for="imagen" style="display:block; margin:0; padding:5px; width:220px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;" class="btn btn-info text-center">
                                    <i class="fa fa-file-image"></i> Seleccionar imagen
                                </label>
                        ...
                        <div class="col-9">
                            <div class="form-group col" style="margin-left: 0;">
                                ...
                                <input name="codigo" type="text" class="form-control border-radius-sm" id="codigo" maxlength="3" required placeholder="K00   -- Utilice mayúscula al inicio --" value="{{ old('codigo') }}">
                                @error('codigo')
