...
@section('b')
    <div>
        <a onclick="cancelar('kioskos')" style="margin:0; padding:5px; width:160px;" type="button"
                    ...
                    <form method="post" action="{{ route('kiosko.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row row-space">
                            <div class="col-3">
                                <div class="font-robo form-group">
                                    <img onclick="elegirImagen()" style="margin-left: 0;" src="/img/LoremKiosko.png"
                                    ...
                                    <label id="label" for="imagen"
                                        ...
                                        class="btn btn-info text-center"> <i class="fa fa-file-image"></i> Seleccionar
                                        imagen</label>
                            ...
                            <div class="col-9">
                                <div class="form-group col" style="margin-left: 0;">
                                    ...
                                    <input name="codigo" type="text" class="form-control border-radius-sm"
                                        id="codigo" maxlength="3" required
                                        placeholder="K00   -- Utilice mayúscula al inicio --" value="{{ old('codigo') }}">
                                    @error('codigo')
                                        <span class="menerr" class="menerr" style="color:red">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group col">
                                    ...
                                    <textarea name="descripcion" style="resize:none" type="tex-area" class="form-control text-area" id="descripcion"
                                        required placeholder="Descripcion del Kiosko">{{ old('descripcion') }}</textarea>
                                    @error('descripcion')
                                        <span class="menerr" class="menerr" style="color:red">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row" style="float:center">
                            <div class="col text-end">
                                ...
                                <button type="button" onclick="cancelar('kioskos')"
