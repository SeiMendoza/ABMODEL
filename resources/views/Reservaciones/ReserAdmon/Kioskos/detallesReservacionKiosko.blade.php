...
@endsection
@section('tit', 'Reservaciones del Kiosko ' . $kiosko->codigo)
@section('b')
    <div>
...
@section('content')
    ...
    @if ($todayReservaciones->count() != 0 || $futureReservaciones->count() != 0)
        ...
        <div class="table-responsive" style="">
            <table class="table" id="" style="">
                ...
                <tbody>
                    @forelse($todayReservaciones as $r)
                        @php  $i = 0;  @endphp

                        <tr style=" height:46px; background-color: rgba(42, 214, 88, 0.1)">
                    ...
                    @forelse($futureReservaciones  as $r)
                        @php  $i = 0;  @endphp
                ...
                <thead>
                    <tr>
                        <th style="text-align:center">
                            <h3>No hay reservaciones en las fechas próximas {{ $futureReservaciones->count() }}</h3>
                        </th>
                    </tr>
                </thead>
            </table>
