...
@section('miga')
    ...
    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white"
            href="{{ route('kiosko.reservaciones', ['id' => $kiosko->id]) }}">Detalle de reservación de kiosko</a></li>
...
@section('b')
    <div>
        ...
        <a href="{{ route('kiosko.reservaciones', ['id' => $kiosko->id]) }}" style="margin:0; padding:5px; width:160px;"
            ...
            <tbody>
                ...
                @forelse($reservaciones  as $r)
                    <tr style=" height:46px">
                        ...
                        <td scope="col" style="text-align:left;">{{ \Carbon\Carbon::parse($r->fecha)->isoFormat('DD') }}
                            de
