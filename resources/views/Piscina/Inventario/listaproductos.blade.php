...
<div class="nav d-flex justify-content-end " style="">
    ...
    <a style="margin: 10px 23px 10px 25px;border: 0; color:aliceblue; background:rgb(33, 195, 247);" data-bs-toggle="modal" 
    data-bs-target="#piscinaregistro" 
    class="btn badge-light"><i class="fa-regular fa-newspaper" style="font-size:15px;"></i> Nuevo producto</a> 

    <div class="modal" id="piscinaregistro" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" 
    aria-labelledby="piscinaregistroLabel" aria-hidden="true">
    <div class=" modal-dialog">
    <div class="modal-content" style="width: 800px">
        <div class="modal-header">
        <h5 class="modal-title" id="piscinaregistroLabel">Agregar una nuevo producto de piscina</h5>
        </div>
        <form method="post" action="{{ route('piscina.store') }}" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <div style="float: left; margin-left: 10px; width: 370px">
                    ...
                    @enderror
                    <br>
                    <label for=""><strong>Seleccione el tiempo de uso:</strong></label>
                ...
                <div style="float: right;margin-top: 20px">
                    <button type="button" onclick="cancelar('productos')" class="btn btn-secondary" >Cerrar</button>
