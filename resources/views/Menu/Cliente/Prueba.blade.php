...
<body style="background-color:rgba(207, 207, 207, 0.34); padding:0px;">
    <script>
    ...
    <div class="" style="width: 100%; padding:0; margin:0;">
        <h2 style="background-color: rgba(160, 0, 0, 0.866); padding:0; margin:0;" class="h4 text-light text-xl-center">Menu del Día</h2>
        <div class="" style="margin: 0px; padding:0; width: 68%; display:block; float:left">
            <div class="row" style="margin: 0px; padding:0;">
                <div class="nav d-flex justify-content-center" style="background-color: rgba(218, 0, 0, 0.79);">
            ...
            <div class="table-responsive" style="height: 574px; overflow-y: scroll; overflow-x: hidden;
            ...
            <div class="row" style="text-align:center; background-color:rgba(218, 0, 0, 0.79); margin: 0; padding:0;">
        ...
        <div class="" style="padding: 0px; background-color:rgba(207, 207, 207, 0.34); width: 32%; margin: 0; display:block; float:left">
            <div class="container-fluid" style="padding: 0px;">
                <form action="{{ route("usuario_pedido.store") }}" id="formulario" name="formulario" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row table-responsive" style="height: 524px; width:460px; margin:0; padding:0;">
                    ...
                    <div class="" style="text-align: center; width:100%; background-color:rgba(155, 155, 155, 0.566);">
                        <a href="#" onclick="cancelar('menu/prueba')" id="cancelar"
                        class="btn btn-danger px-6" style="margin: 5px 1px 4px 1px">Cancelar</a>
                        <a href="#" onclick="guardar()" id="procesar-compra"
                            class="btn btn-success px-6" style="margin: 5px 1px 4px 1px">Guardar</a>
                    </div>
                </form>
            </div>  
        </div>
