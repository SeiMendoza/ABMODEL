...
<body>
    ...
    <header class="container-fluid bg-primary position-absolute top-0 " >
        <ul
          class="nav nav-pills mb-4 py-3 container"
          id="pills-tab"
          role="tablist" style="position: relative; top:10px;">
                                                                ...
                                                                <div class="col-12">
                                                                    <div>
                                                                        <div class="text-center">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col">
                                                                                    <a  class="col-12 btn btn-danger w-35 form button"><i class="ni ni-bell-55 text-lg opacity-10" aria-hidden="true"></i> Agregar</a>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="col-12">
                                                                    <div>
                                                                        <div class="text-center">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col">
                                                                                <a  class="col-12 btn btn-danger w-50 form button"><i class="ni ni-bell-55 text-lg opacity-10" aria-hidden="true"></i> Agregar</a>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="col-12">
                                                                    <div>
                                                                        <div class="text-center">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col">
                                                                                <a  class="col-12 btn btn-danger w-55 form button">
                                                                                    <i class="ni ni-bell-55 text-lg opacity-10" aria-hidden="true"></i> Agregar</a>
                                                                                </div>
                                                                            </div>
