...
<h5 class="card class-4 text-lg text-center" style="background:#2ff67b; color:#fff;
      position: relative;">DETALLES DEL PEDIDO ANTERIOR DE: {{$pedido->nombreCliente}}</h5>
...
<a href="{{ route('pedidoant.pedidos_anteriores')}}" class="btn btn-danger" type="buttom" style="float: right;">Regresar</a>
