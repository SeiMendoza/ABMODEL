...
<body class="" style="">
        ...
        <div class="row" style="margin: 0px; padding:0;">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 d-table-cell" style="margin: 0px; padding:0;">
                <div class="row" style="margin: 0px; padding:0;">
                                        ...
                                        <a href="javascript:;" class="nav-link text-white p-0" id="iconNavbarSidenav">
                                            <div class="sidenav-toggler-inner">
                                                    ...
                                                    <a href="javascript:;" class="nav-link 
                                                        ...
                                                        style="margin:4px 3px 1px 3px; padding:8px; width:100px; font-size:15px"
                                                    ...
                                                    aria-labelledby="userDropdown" style="margin: 0%; padding:0%;">
                                                        <div class="dropdown-item col-4 d-table-cell border-radius-top-end-0 " style="display:block; float:right; margin: 0px; padding:0;">                    
                                                            ...
                                                            <div style="height: 381px; margin:0px; overflow-y:auto;">
                    ...
                    <div class=" d-none d- d-md-table d-lg-table d-xl-table col-5 d-table-cell" style="display:block; float:right; margin: 0px; padding:0;">   
                        <div class="row " style="margin: 0px; padding:0;">
    ...
    <div class="fixed-plugin" style="margin:0%; padding:0%;">
        <div class="card col-5" style="margin:0%; padding:0%;">
            <div class="card-body pt-0 overflow-auto" style="margin:0%; padding:0%;">
                <div class="d-table-cell border-radius-top-end-0 " style="display:block; float:right; margin: 0px; padding:0;">   
                    <div class="row " style="margin: 0px; padding:0;">
                        <nav aria-label="breadcrumb" style=" margin: 0px; padding:0;">
                            <ol class="breadcrumb d-flex justify-content-center bg-gradient-faded-success" style="margin-bottom: 0; border-radius:0px;">
                                <H3 class="text-white"><strong>Detalles del Pedido</strong></H3>
                    ...
                    <div style="">
                        <div class="input-group" style="margin: 0; border: 0; width: 99%">
                            ...
                            <select name="mesa" style="height:42px; border-radius:0; margin: 5px 0px 5px 23px; width:80px" id="mesa"
                                class="form-control input--style-2 border-0 ps-2 font-robo" step="0.001" oninput="nombre()">
                                @if (old('mesa'))
                                <option disabled="disabled" value="">Seleccione una mesa</option>
                                    @foreach ($mesas as $c)
