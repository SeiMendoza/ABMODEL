...
<!--complementos-->
<div class="tab-pane fade" id="pills-complementos" role="tabpanel" aria-labelledby="pills-Cdisponible-tab">
                    ...
                    <table class="table menu" class="table" id="CombosDisponibles" style="">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td scope="col" style="text-align: end;">L {{ $p->precio }}.00</td>
                                <td scope="col" style="text-align: center;">
                                    <i data-bs-toggle="modal" data-bs-target="#activarComplemento{{ $p->id }}">
                                        <a class="fa fa-times-circle text-warning"></a>
                                        Desactivar</i>
                                    <form action="{{ route('combo.activar', ['id' => $p->id]) }}" method="post"
                                        enctype="multipart/form-data">
                                        @method('put')
                                        @csrf
                                ...
                                <td scope="col" style="text-align: center;"><a href="#"><i
                                            class="fa fa-edit text-success"></i></a></td>
                                <td scope="col" style="text-align: center;">
                                    <i data-bs-toggle="modal" data-bs-target="#eliminarComplemento{{ $p->id }}"
                                        class="fa-solid fa-trash-can text-danger" style="color:crimson"></i>
                                    <form action="{{ route('combo.borrar', ['id' => $p->id]) }}" method="post"
                                        enctype="multipart/form-data">
                                        @method('delete')
                                        @csrf
                                        <div class="modal fade" id="eliminarComplemento{{ $p->id }}"
                                            data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                            aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                            ...
                            <tr>
                                ...
                                <td scope="col" style="text-align: center;"><a
                                        href="{{ route('combo.editar', ['id' => $p->id]) }}"><i
                                            class="fa fa-edit text-success"></i></a></td>
                                <td scope="col" style="text-align: center;">
                                    <i data-bs-toggle="modal" data-bs-target="#eliminarCombo{{ $p->id }}"
                                        class="fa-solid fa-trash-can text-danger" style="color:crimson"></i>
                                    <form action="{{ route('combo.borrar', ['id' => $p->id]) }}" method="post"
                                        enctype="multipart/form-data">
                                        @method('delete')
                                        @csrf
                                        <div class="modal fade" id="eliminarCombo{{ $p->id }}" data-bs-backdrop="static"
                                            data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
                                            aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
