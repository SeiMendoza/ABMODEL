...
@section('title', 'Edicion de Platillo')
@section('miga')
<li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="{{route('menuAdmon.platillos')}}">Administración de menú</a></li>
<li class="breadcrumb-item text-sm text-dark active text-white" aria-current="page">Editar</li>
@endsection
@section('tit', 'Edición de Producto')
@section('b')
<div>
    <a href="{{route('menuAdmon.platillos')}}" style="margin:0; padding:5px; width:160px;" type="button" class="bg-light border-radius-sm text-center ">
                ...
                <div class="row">
                   ...
                   <div>
                    ...
                    <div style="float: right; margin-top: 5px">
                        ...
                        <button type="button" onclick="cancelarAct('¿Desea cancelar la actualización del platillo?','admonRestauranteP')"
