            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('platobebida.update', ['id' => $PlatillosyBebidas -> id]) }}" enctype="multipart/form-data">
                    ...
                    <div style="margin-left:2%;float:left;width:35%">
                        ...
                        @enderror
                        <br>
                        <input class="input--style-2" type="text" placeholder="Nombre" name="nombre" value="{{old('nombre', $PlatillosyBebidas->nombre)}}" maxlength="25" required onkeypress="quitarerror()">
                        @error('nombre')
                        <strong class="menerr" style="color:red">{{ $message }}</strong>
                        @enderror
                        <br><br>
                        <textarea class="textarea--style-2" type="text" placeholder="Descripción" name="descripcion" maxlength="100" required onkeypress="quitarerror()">{{old('descripcion', $PlatillosyBebidas->descripcion)}}</textarea>
                        @error('descripcion')
                        <strong class="menerr" style="color:red">{{ $message }}</strong>
                        @enderror
                        <br><br>
                    ...
                    <div style="margin-left:2%;float:left;width:35%">
                        ...
                        @enderror
                        <br>
                        <input class="input--style-2" type="number" placeholder="Precio" name="precio" value="{{old('precio', $PlatillosyBebidas->precio) }}" onkeypress="quitarerror()" required onkeydown="javascript: return event.keyCode == 69 ? false : true" min="1" max="1000">
                        @error('precio')
                        <strong class="menerr" style="color:red">{{ $message }}</strong>
                        @enderror
                        ...
                        <div id="bebida" style="display:none">
                            <br>
                            <input class="input--style-2" type="number" placeholder="Bebidas disponibles" name="cantidad" id="cantidad" value="{{old('cantidad', $PlatillosyBebidas->cantidad) }}" onkeypress="quitarerror()" onkeydown="javascript: return event.keyCode == 69 ? false : true" min="1" max="1000" disabled>
                            @error('cantidad')
                        ...
                        <div id="comida" style="display:none">
                            <br>
                            <input class="input--style-2" type="number" placeholder="Platillos disponibles" name="disponible" id="disponible" value="{{old('disponible', $PlatillosyBebidas->disponible)}}" onkeypress="quitarerror()" onkeydown="javascript: return event.keyCode == 69 ? false : true" min="1" max="1000" disabled>
                            @error('disponible')
                            <strong class="menerr" class="menerr" style="color:red">{{ $message }}</strong>
                            @enderror
                            <br><br>
