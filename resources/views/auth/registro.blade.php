...
<li class="breadcrumb-item text-sm text-dark active text-white" aria-current="page">Nuevo Usuario</li>
@endsection
@section('tit','Registro de Usuarios')
    ...
    <div class="wrapper wrapper--w960"> <!--aquí iria el wrapper-->
        <div class="card border-radius-sm border-0" style="">
            <div class="card-body border-radius-sm border-0">
                ...
                <form method="POST" action="{{ route('usuarios.create')}}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col">
                            ...
                            <div class="row" style="margin-left:20px">
                                ...
                                <div class="col">
                                    ...
                                    <input class="form-control border-radius-sm" type="number" required placeholder="Ingrese el número telefonico" name="telephone" 
                                       value="{{ old('telephone') }}" maxlength="8"  minlength="8" >
                                    @error('telephone')
                                        <strong class="menerr" style="color:red">{{ $message }}</strong>
                                    @enderror
                                </div>
                            ...
                            <div class="row" style="margin-left:20px">
                                <div class="col">
                                    ...
                                    <input class="form-control border-radius-sm" type="email" placeholder="Ingrese un correo" name="email" 
                                       value="{{ old('email') }}" required onkeypress="quitarerror()"
						...
						<div class="row" style="margin-left:20px">
							<div class="col">
								 ...
								 <input class="form-control border-radius-sm" type="password" placeholder="Ingrese una contraseña" name="password"
								   value="{{ old('password') }}" maxlength="40" required onkeypress="quitarerror()" autocomplete="new-password">
								@error('password')
								   <strong class="menerr" style="color:red">{{ $message }}</strong>
								@enderror
							</div>
							...
							<div class="col">
								...
								<input class="form-control border-radius-sm" type="password" placeholder="Confirmar la contraseña" name="password_confirmation" 
								   value="{{ old('confirm') }}" required onkeypress="quitarerror()" required autocomplete="new-password">
								@error('confirm')
									<strong class="menerr" style="color:red">{{ $message }}</strong>
								@enderror
							</div>
						...
						<BR>
                            <div class="row" style="margin-left:20px">
                                <div class="col">
                                    ...
                                    onkeypress="quitarerror()">{{ old('address') }}</textarea>
                                    @error('address')
                                        <strong class="menerr" style="color:red">{{ $message }}</strong>
                                    @enderror
                                </div>  
