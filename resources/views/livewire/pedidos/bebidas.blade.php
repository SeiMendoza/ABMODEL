<div class="row justify-content-center" style="margin: 0px; padding:0;">
    @foreach($products as $pro)
        ...
        @foreach ($items as $item)
            ...
            @endif
        @endforeach
        <div class="col col-auto col-xs-6 col-sm-4 col-md-6 col-lg-4 col-xl-3" style=" margin:0px; padding:0; width:213px;" style="">
