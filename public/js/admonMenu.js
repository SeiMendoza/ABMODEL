$(function () {
    ...
    tableInit('complementosDisponibles', "/admonRestauranteC", 1);
    tableInit('complementosNoDisponibles', "/admonRestauranteC", 0);

    tableInit('platillosDisponibles', "/admonRestauranteP", 1);
    tableInit('platillosNoDisponibles', "/admonRestauranteP", 0);

    tableInit('bebidasDisponibles', "/admonRestauranteB", 1);
    tableInit('bebidasNoDisponibles', "/admonRestauranteB", 0);

    $('#modalDeleteProductos').on('hidden.bs.modal', function (e) {
        $(fila).removeClass('delete');
    });

    $('#modalActivarProductos').on('hidden.bs.modal', function (e) {
        $(fila).removeClass('activate');
    });
    ...
    $('#btnConfirmDeleteProduct').click(function (e) {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                ...
                setTimeout(function () { $('#modalDeleteProductos').modal('hide'); }, 40); //Ocultar modal
    ...
    $(document).on('click', '.btnActivar', function (e) {
        ...
        $('#modalActivarProductos').modal('show');
        $(fila).addClass('activate');
    ...
    $('#btnConfirmarActivacion').click(function (e) {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                ...
                setTimeout(function () { $('#modalActivarProductos').modal('hide'); }, 40); //Ocultar modal
                $('.table').DataTable().ajax.reload(null, false); //recargar Datatable
...
function tableInit(tableId, url, estado) {
    ...
    $('#' + tableId).DataTable({
        ...
        responsive: true,
        bAutoWidth: false,
        //scrollY: 320, //scroll dentro del datatable
        pageLength: 10,
        ...
        "columnDefs": [
            ...
            // } ,
            {
                ...
                "targets": 2,
                "render": $.fn.dataTable.render.number(',', '.', 2, 'L '), //dar formato a la columna de Precio
